...
import { Face, Home, LocalPolice, MinorCrash, PersonAdd } from '@mui/icons-material';
          ...
          {menuOptions.map((text, index) => (
            <ListItem key={text.label} disablePadding>
              <ListItemButton>
                ...
                <ListItemText primary={<Link style={{textDecoration: "none", }} to={`/${text.route}`}>{text.label}</Link>} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
